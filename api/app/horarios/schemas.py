...
class HorarioBase(BaseModel):
    ...
    fecha_clase: date = Field(..., description="Fecha de la clase en formato YYYY-MM-DD")
    dia: Optional[DiasSemana] = Field(None, description="Día de la semana (opcional)")
...
class HorarioUpdate(BaseModel):
    ...
    fecha_clase: Optional[date] = Field(None, description="Fecha de la clase en formato YYYY-MM-DD")
    dia: Optional[DiasSemana] = Field(None, description="Día de la semana (opcional)")
